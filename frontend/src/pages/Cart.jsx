                ...
                <div className='flex items-start gap-6'>
                  ...
                  <div>
                    ...
                    <div className='flex items-center gap-5 mt-2'>
                      ...
                      <p className='px-2 sm:px-3 sm:py-1'></p>
                    </div>
                  </div>
                </div>
                <input onChange={(e)=> e.target.value ==='' || e.target.value === '0' ? null : updateQuantity(item._id,Number(e.target.value))} className='border max-w-10 sm:max-w-20 sm:px-2 py-1' type="number" min={1} defaultValue={item.quantity}/>
