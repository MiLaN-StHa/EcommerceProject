...
const Navbar = () => {
  ...
  const [showDropdown, setShowDropdown] = useState(false); // New state for dropdown on mobile
  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
      <Link to='/'><img src={logo} className='w-28 h-[120px]' alt="Logo" /></Link>
      ...
      <div className='flex items-center gap-6'>
        ...
        <div className='group relative'>
          {/* Profile Icon */}
          <img
            onClick={() => token ? toggleDropdown() : navigate('/login')} // Toggle dropdown on small screens
            src={assets.profile_icon} className='w-5 cursor-pointer'
            onMouseEnter={() => window.innerWidth > 768 && setShowDropdown(true)} // Hover on larger screens
